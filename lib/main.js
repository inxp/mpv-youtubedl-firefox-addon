...
function getFormats(url) {
    ...
    if (ytdlPath === null || ytdlPath.indexOf("youtube-dl") === -1) {
		panel.width = 250;
		panel.height = 97;
		panel.port.emit("status", "Youtube-dl not found, please check path in add-on settings.");
